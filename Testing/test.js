...
let num2 = 200;
let str2 = 'sum';
let arrobj = [{ first: null }, { second: 'second' }, { third: { fourth: null, fifth: 'fifth' } }];
let arrobj2 = [{ first: null }, { second: 'second' }, { third: { fourth: 'furth', fifth: undefined } }];
